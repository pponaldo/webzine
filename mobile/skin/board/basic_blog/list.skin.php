    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
            ...
            <!--- 본문리스트 추가부분 시작-->
             	...
             	<?php if($member[mb_level] > $user_level) {?>

                       <h1>             	
                           <a  style="color:#4B48BB;font-size:1.2em" href="<?php echo $list[$i]['href'] ?>">
                ...
                <?php }else{ ?>                 	               	               
                    <header>
                       <h1 id="bo_v_title">
                           <?php
                           if ($category_name) echo $list[$i]['ca_name'].' | '; // 분류 출력 끝
                ...
                <?php } ?>
                   ...
                   <section id="bo_v_info">
                       <h2>페이지 정보</h2>
                       작성자 <strong><?php echo $list[$i]['name'] ?><?php if ($is_ip_view) { echo "&nbsp;($ip)"; } ?></strong>
                       <span class="sound_only">작성일</span><strong><?php echo date("Y-m-d H:i", strtotime($list[$i]['wr_datetime'])) ?></strong>
